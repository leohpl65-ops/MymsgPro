                    ...
                    <Button className="w-full" onClick={async () => {
                      ...
                      try {
                        ...
                        if (user && user.email) {
                          ...
                          setShowGoogleDialog(false);
                          import("@/hooks/use-toast").then(({ toast }) => {
                            toast({ description: `Cuenta vinculada correctamente con ${user.email}`, duration: 3000 });
                          });
                        }
                      } catch (error: any) {
                        console.error("Error with Google Sign-In", error);
                        import("@/hooks/use-toast").then(({ toast }) => {
                          toast({ title: "Error", description: "No se pudo vincular la cuenta de Google.", duration: 3000, variant: "destructive" });
                        });
                      }
